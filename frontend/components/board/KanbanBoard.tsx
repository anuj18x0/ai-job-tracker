        ...
        <>
          ...
          <div className="px-6 pb-2 flex justify-end">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-secondary/50 border border-border/50 text-[11px] font-bold text-muted-foreground hover:bg-secondary hover:text-foreground transition-all uppercase tracking-wider"
            >
